This application is an extension to (spring-boot-todo-web-application-sessions) application
In current application "spring-boot-todo-web-application-addtodo" we added functionality to add new todo

spring-boot-todo-web-application-sessions
-------------------------------------------------------------------------------------------------------------
...
----------------------------------
https://github.com/gauravsaxena1611/SpringBootWebApplicationStepByStep/blob/master/Step13.md
