This application is an extension to (spring-boot-todo-web-application-jstl) application
In current application "spring-boot-todo-web-application-bootstrap" we added just enhanced CSS using BOOTSTRAP framework

spring-boot-todo-web-application-jstl
-------------------------------------------------------------------------------------------------------------
